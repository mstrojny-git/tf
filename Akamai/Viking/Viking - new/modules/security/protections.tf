...
/*resource "akamai_appsec_api_constraints_protection" "testing" {
  config_id          = local.config_id
  security_policy_id = akamai_appsec_security_policy.testing.security_policy_id
  enabled            = false
}*/
...
/*resource "akamai_appsec_malware_protection" "testing" {
  config_id          = local.config_id
  security_policy_id = akamai_appsec_security_policy.testing.security_policy_id
  enabled            = false
}*/
...
/*resource "akamai_appsec_reputation_protection" "testing" {
  config_id          = local.config_id
  security_policy_id = akamai_appsec_security_policy.testing.security_policy_id
  enabled            = false
}*/
