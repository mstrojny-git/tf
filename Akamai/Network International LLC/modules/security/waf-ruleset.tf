resource "akamai_appsec_waf_ruleset" "ni_corporate_api_" {
...
resource "akamai_appsec_waf_ruleset" "ni_corporate_websites" {
  config_id          = local.config_id
          ...
          "conditions" : [
            {
              ...
              "positiveMatch" : true,
              "clientLists" : [
                "263796_WAFSECURITYFILEXSSATTAC"
              ]
            }
          ]
        } }
              ...
              "criteria" : [
                {
                  ...
                  "paths" : [
                    "/api/salesforce/merchant",
                    "/onboarding/create",
                    "/NI/UploadMerchantBulkUpdateAttachment.jsp"
                  ]
                }
              ],
...
resource "akamai_appsec_waf_ruleset" "neo_production" {
  config_id          = local.config_id
...
resource "akamai_appsec_waf_ruleset" "onboarding_alert" {
  config_id          = local.config_id
...
resource "akamai_appsec_waf_ruleset" "network_international" {
  config_id          = local.config_id
