...
$NewPolicyName = "sdurand-test-clone"
...
# List Match targets
$CloneAppSecSecurityPolicyParams = @{
    ConfigID        = $ConfigId
    VersionNumber   = $ConfigVersion
    PolicyId        = $PolicyId
...
Write-Host "Cloning policy $PolicyName to $NewPolicyName in security config $ConfigName..."
Clone-AppSecSecurityPolicy @CloneAppSecSecurityPolicyParams
